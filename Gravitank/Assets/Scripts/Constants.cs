...
{
    // Shooting.cs
    public const float SHOT_COOLDOWN = 2; //seconds
    ...
    public const float SHOT_DAMAGE_TIME_COEFFICIENT = 1.5f;
    ...
    // Meteor generation
    public const float BASE_METEOR_FREQUENCY = 0.001f;
    public const float TIME_METEOR_FREQUENCY_COEFFICIENT = 0.001f;
    
    public const float METEOR_MIN_DISTANCE= 5;
    public const float METEOR_MAX_DISTANCE= 10;
    public const float METEOR_MAX_FORCE_MAGNITUDE= 10;

    //Meteor
    public const float METEOR_MAX_VELOCITY = 10;
